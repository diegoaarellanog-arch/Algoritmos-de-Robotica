...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(290, 0, 461, 71))
        font = QtGui.QFont()
        ...
        self.horizontalSlider.setMinimum(1) # Evitar división por cero
        ...
        self.horizontalSlider_2.setMinimum(1) # Evitar división por cero
        ...
        self.label_5.setGeometry(QtCore.QRect(340, 70, 381, 331))
        ...
        # --- LABELS PARA VALORES DINÁMICOS ---
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(200, 180, 55, 16))
        self.label_8.setObjectName("label_8")
        
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setGeometry(QtCore.QRect(200, 260, 55, 16))
        self.label_9.setObjectName("label_9")
        
        self.label_10 = QtWidgets.QLabel(self.centralwidget)
        self.label_10.setGeometry(QtCore.QRect(200, 340, 55, 16))
        self.label_10.setObjectName("label_10")
        
        # --- UNIDADES ---
        self.label_11 = QtWidgets.QLabel(self.centralwidget)
        self.label_11.setGeometry(QtCore.QRect(270, 180, 55, 16))
        self.label_11.setObjectName("label_11")
        
        self.label_12 = QtWidgets.QLabel(self.centralwidget)
        self.label_12.setGeometry(QtCore.QRect(270, 260, 55, 16))
        self.label_12.setObjectName("label_12")
        
        self.label_13 = QtWidgets.QLabel(self.centralwidget)
        self.label_13.setGeometry(QtCore.QRect(270, 340, 55, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Simulador RC"))
...
"Diego Alejandro Arellano - 110847"))
        ...
        self.label_11.setText(_translate("MainWindow", "Ohm"))
    ...
    def actualizar_grafica(self):
        ...
        res_val = self.horizontalSlider.value()
        cap_val = self.horizontalSlider_2.value()
        vol_val = self.horizontalSlider_3.value()

        # 2. Actualizar labels de valor numérico (Punto solicitado)
        self.label_8.setText(str(res_val))
        self.label_9.setText(str(cap_val))
        self.label_10.setText(str(vol_val))

        # 3. Cálculos físicos
        R = res_val * 1000   # Kilo-Ohms a Ohms
        C = cap_val * 1e-6   # micro-Faradios a Faradios
        V = vol_val          # Voltios
        ...
        self.ax.set_title("Comportamiento del Capacitor")
...
# Importar el archivo de recursos (asegúrate de que imagen_rc.py esté en la misma carpeta)
import imagen_rc
